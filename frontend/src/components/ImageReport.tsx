...
const ImageReport: React.FC<Props> = ({ result, previewUrl }) => {
  const risk = result.risk_assessment;

  const photoPanel = previewUrl && (
    <div className="kyc-photo-col">
      <div className="kyc-photo-sticky">
        <img src={previewUrl} alt="Submitted" className="kyc-photo" />
        <p className="kyc-photo-caption">Submitted Photo</p>
      </div>
    </div>
  );
  ...
  if (!risk) {
    return (
      <div className="kyc-report">
        {photoPanel}
        <div className="kyc-info-col report-fallback">
